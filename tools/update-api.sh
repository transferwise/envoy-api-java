...
curl -sL https://github.com/googleapis/googleapis/archive/${GOOGLEAPIS_VERSION}.tar.gz | tar xz --include '*.proto'
...
curl -sL https://github.com/cncf/xds/archive/${XDS_VERSION}.tar.gz | tar xz --include '*.proto'
